...
const STORY = {
  start: {
    ...
    cta: "落子入局",
    historyNote: {
      fact: "韩非为韩国宗室公子，与李斯同受业于荀卿（荀子），喜刑名法术之学，而其归本于黄老。他见韩国日益削弱，多次上书韩王图谋富强，韩王终不能用，于是发愤著书，作《孤愤》《五蠹》《说难》等篇。其生年史无确载，卒于秦王政十四年（公元前233年）。\n依据：《史记·老子韩非列传》。",
  ...
  act1: {
    ...
    beats: [
      ...
      { t: "dlg", who: "紫女", text: "皑皑血衣侯，石上翡翠虎。碧海潮女妖，月下蓑衣客。姬无夜只是露在水面上的那块礁石。" },
  ...
  act4: {
    ...
    beats: [
      ...
      { t: "narr", text: "李斯在侧席坐着，目光复杂。他们曾同窗，如今一个是秦之重臣，一个是韩之羁臣。旧谊还在，只是旧谊之外，多了天下。" },
      { t: "choice", choices: [
        {
...
const ENDINGS = {
  ...
  legacy: { eyebrow: "结局 · 其三", title: "子房",
    body: ["张良展开那封长信时，指节是抖的。信上没有眼泪，只有一笔一画的法、术、势，和一句写在末尾的话：","——“子房聪颖过我，所欠者唯阅历耳。此道孤且险，然天下终须有人行之。”","很多年后，张良站在博浪沙的力士身侧，又站在灞上的军帐之中，再后来，他站在留县的封地前，自称“留侯”。","他没有活成韩非。他比韩非走得更远，也更懂得藏。可每当他做出一个艰难的决定，总会想起新郑雨里那个漫不经心的公子。那人没看到天下一统，却把如何看待天下的眼睛，留给了他。","他曾说要七国的九十九。子房后来才懂，他要的从来不是九十九本身，而是有人在他死后，把这局棋看完。"],
