...
const STORY = {
  ...
  act5: {
    ...
    beats: [
      ...
      { t: "narr", text: "案上摆着李斯送来的药。墙角，阴阳家留下的咒纹在皮肤上隐隐发烫。韩非知道，自己走不出这扇门了。" },
      { t: "dlg", who: "李斯", text: "药……是我送的。咒，不是我下的。师兄，这两件事，你要分清楚。" },
            { t: "dlg", who: "韩非", text: "分得清。你送药，是尽同门之义；咒纹，是尽人臣之忠。你看，你我都活到了把“义”和“忠”拆开来做的地步。" },
      ...
      { t: "narr", text: "他忽然明白了。逆鳞从来只挡迎面而来的刀：潮女妖的幻术、天泽的杀手、暗夜里的箭。可六魂恐咒不是刀。它从身体里面长出来，像一颗种子，在他钻研苍龙七宿的那一刻就已经埋下。" },
